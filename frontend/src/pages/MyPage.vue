    ...
    <section class="mypage-card">
      ...
      <div class="inq-stat-grid">
        <div class="inq-stat-card inq-stat-blue">
          ...
          <span class="inq-stat-label">저장된 문의</span>
        ...
        <div class="inq-stat-card inq-stat-orange">
          ...
          <span class="inq-stat-label">확인 대기</span>
        ...
        <div class="inq-stat-card inq-stat-green">
          ...
          <span class="inq-stat-label">납품 가능</span>
        ...
        <div class="inq-stat-card inq-stat-red">
          ...
          <span class="inq-stat-label">거절</span>
...
const rejectedCount = computed(() => inquiries.value.filter(i => rejectedStatuses.has(i.status)).length);

onMounted(async () => {
  try {
    inquiries.value = filterInquiriesForUser(await getSupplierInquiries(), authState.user);
  } catch { /* pass */ }
