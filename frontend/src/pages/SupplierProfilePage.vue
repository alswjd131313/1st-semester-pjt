<template>
  <main class="supplier-profile-page">
    <header class="page-header">
      <button class="back-btn" type="button" @click="router.back()">← 뒤로</button>
      <div>
        <p class="eyebrow">Supplier Material Management</p>
        <h1>공급사 프로필</h1>
